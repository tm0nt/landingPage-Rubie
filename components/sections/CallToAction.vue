<template>
    <section class="py-20">
        <AtomsContainer>
            <div
                class="w-full relative py-8 md:py-10 px-6 md:px-8 rounded-2xl bg-gradient-to-tr dark:to-body-color">
                ...
                <div class="mx-auto text-center max-w-xl md:max-w-2xl relative">
                    <h2 class="text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6x">
                         Potencialize sua presença online <span
                            class="text-transparent bg-clip-text bg-gradient-to-br from-primary to-[#d31717]">agora</span>
                    </h2>
